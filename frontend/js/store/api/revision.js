...
export default {
  getRevisionContent (id, callback) {
    ...
    axios.get('http://www.mocky.io/v2/59d77e61120000ce04cb1c5b', { id: id }).then(function (resp) {
  ...
  getCurrentContent (param, callback) {
    ...
    // Set endpoint in global config
    axios.get('http://www.mocky.io/v2/59d77e61120000ce04cb1c5b', { param: param }).then(function (resp) {
      // new full html content
