...
const state = {
  ...
  page: Number(window.STORE.datatable.page || 1),
  maxPage: Number(window.STORE.datatable.maxPage || 1),
  defaultMaxPage: Number(window.STORE.datatable.defaultMaxPage || 1),
  offset: Number(window.STORE.datatable.offset || 60),
  defaultOffset: Number(window.STORE.datatable.defaultOffset || 60),
