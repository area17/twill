<template>
  <div class="publisher__wrapper">
      ...
      <a17-pubaccordion :date-display-format="dateDisplayFormat" :date-format="dateFormat" :date_24h="date_24h" :open="openStates['A17Pubaccordion']" @open="openCloseAccordion" v-if="withPublicationTimeframe">Published on</a17-pubaccordion>
