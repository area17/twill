<template>
  <a17-inputframe :custom-error-key="customErrorKey" :error="error" :note="note" :label="label" :locale="locale" @localize="updateLocale" :size="size" :name="name" :label-for="uniqId" :required="required">
