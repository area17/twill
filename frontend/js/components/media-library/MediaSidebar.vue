      ...
      <form v-if="hasMedia" ref="form" class="mediasidebar__inner mediasidebar__form" @submit="submit">
        ...
        <template v-else>
          ...
          <a17-locale type="a17-textfield" v-if="isImage && translatableMetadatas.includes('alt_text')"
                      :attributes="{ label: $trans('media-library.sidebar.alt-text'), name: 'alt_text', type: 'text', size: 'small' }"
                      :initialValues="altValues" @focus="focus" @blur="blur"></a17-locale>
          <a17-textfield v-else-if="isImage" :label="$trans('media-library.sidebar.alt-text')" name="alt_text"
          ...
          <a17-locale type="a17-textfield" v-if="isImage && translatableMetadatas.includes('caption')"
                      :attributes="{ type: 'textarea', rows: 1, label: $trans('media-library.sidebar.caption'), name: 'caption', size: 'small' }"
                      :initialValues="captionValues" @focus="focus" @blur="blur"></a17-locale>
          <a17-textfield v-else-if="isImage" type="textarea" :rows="1" size="small" :label="$trans('media-library.sidebar.caption')" name="caption"
