                ...
                <div class="wrapper wrapper--reverse" v-sticky data-sticky-id="publisher" data-sticky-offset="80">
                    <aside class="col col--aside">
                        <div class="publisher" data-sticky-target="publisher">
                            <a17-publisher :show-languages="{{ json_encode($controlLanguagesPublication) }}" switcher-title="@lang('twill::lang.form.switcher-title')"></a17-publisher>
                            <a17-page-nav
...
@section('initialStore')
    ...
    window.STORE.publication = {
        ...
        publishedLabel: '{{ $customPublishedLabel ?? __('twill::lang.main.published') }}',
        draftLabel: '{{ $customDraftLabel ?? __('twill::lang.main.draft') }}',
