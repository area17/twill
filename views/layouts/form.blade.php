...
@section('content')
    ...
    <a17-dialog ref="warningContentEditor" modal-title="{{ twillTrans('twill::lang.modal.delete.title') }}" confirm-label="{{ twillTrans('twill::lang.modal.delete.confirm') }}">
        <p class="modal--tiny-title"><strong>{{ twillTrans('twill::lang.modal.delete.title') }}</strong></p>
        <p>{{ twillTrans('twill::lang.modal.prompt.top-text') }}<br />{{ twillTrans('twill::lang.modal.prompt.bottom-text') }}</p>
    </a17-dialog>
@stop
