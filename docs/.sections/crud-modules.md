...
public function getFormFields($object) {
    ...
    $fields = $this->getFormFieldsForRepeater($object, $fields, 'repeaterItemName', 'relationName', 'ModelName');
...
public function afterSave($object, $fields) {
    ...
    $this->updateRepeater($object, $fields, 'repeaterItemName', 'relationName', 'ModelName');
