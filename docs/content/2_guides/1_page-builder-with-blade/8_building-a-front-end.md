...
In Laravel a common approach is to use a combination of [routes](https://laravel.com/docs/routing) and
[controllers](https://laravel.com/docs/controllers) to build a front-end.
...
We added a show method, that takes a slug as argument. Inside we [dd](https://laravel.com/docs/helpers#method-dd)
