...
Luckily, Twill comes with a few useful [artisan](https://laravel.com/docs/artisan) commands. (Artisan is the command
...
[official documentation](https://laravel.com/docs/providers).
...
`TwillNavigation` is a [Facade](https://laravel.com/docs/facades#main-content) that Twill provides to manage the
administration menu.
