...
Twill `3.x` is compatible with Laravel versions `9.x`. `10.x`, `11.x`, `12.x` and `13.x` running on PHP `8.0` and above. As a dependency to your
...
- [Valet](https://laravel.com/docs/valet) (macOS)
- [Sail](https://laravel.com/docs/sail) (All platforms)
- [Homestead](https://laravel.com/docs/homestead) (All platforms)
...
Of course, any other Laravel compatible server configuration and deployment strategy is supported.
