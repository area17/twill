...
Each `bucketable` should have its [model morph map](https://laravel.com/docs/eloquent-relationships#polymorphic-relationships) defined because features are stored in a polymorphic table.
