...
abstract class SubModuleController extends ModuleController
{
    ...
    protected function getBreadcrumbParent($parent_id, $item_id, $append = [])
    {
        ...
        $breadcrumb[ucfirst($nameModules[0])] = moduleRoute($nameModules[0], $this->routePrefix, "index");
        ...
        if ( $item_id )
            $breadcrumb[ucfirst($nameModules[1])] = moduleRoute($this->moduleName, $this->routePrefix, "index",[$parent_id]);
