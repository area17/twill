...
> As soon as custom code needs to be added to the `<script>` section of a block Vue file, it is still needed to re-build Twill's frontend using the documented npm scripts.
> It is now possible to define a block as being `compiled` in the `twill.block_editor.blocks` array so that the imported SFC is prefered at runtime over the inline, template-only, version.
...
- [`#510`](https://github.com/area17/twill/pull/510) Fix custom blocks when inline rendering is enabled [`1e041285`](https://github.com/area17/twill/commit/1e0412857f54499b88935ce6e5cb6e8c71632317)
- Add build command timeout to configuration and defaults to 300s [`13a37fb5`](https://github.com/area17/twill/commit/13a37fb5d699f3ce44074ed6c2af3a925ae489e1)
> Also clarify build command description since this is not about building Blade generated blocks anymore,  those being dynamically rendered when `twill.block_editor.inline_blocks_templates` is true, which is by default in 2.0.
- Remove socket port from dev server configuration [`c309a3a1`](https://github.com/area17/twill/commit/c309a3a1bb89f77a671da950c05943b152fa9ce5)
> Port will automatically be selected if 8080 (default) is not available. In this case, the `twill.dev_mode_url` configuration needs to be updated (TWILL_DEV_MODE_URL is available as an environment variable)
- Add npm script to clean custom blocks and components directories [`4a61875d`](https://github.com/area17/twill/commit/4a61875dc7eb3474bf7f1f6c17cc5858582b1bea)
- Make frontend changes backward compatible [`9bc9c249`](https://github.com/area17/twill/commit/9bc9c24925ea1bf857026f5f6a3db90ab099970f)
> window.STORE and window.vm were being used to hook into Twill by some developers. This commit make sure to keep that working even though a namespace was added.
- Add dev modes to twill:build: hot and watch [`dc0c5043`](https://github.com/area17/twill/commit/dc0c504348579a3732a069e7c97e68abbe2feeee)
...
- Add npm script to build distributed Twill assets [`43f4f6e1`](https://github.com/area17/twill/commit/43f4f6e1c2fb86a9491cd4191f841b463b4a8a9c)
...
- Fix edge cases [`b86e8d2d`](https://github.com/area17/twill/commit/b86e8d2db690e43ce26d81c04126c75d7adcc98f)
- Refactor block editor field allowed blocks logic [`f80278c0`](https://github.com/area17/twill/commit/f80278c0703d2942a9150d2b192abda29e11c5d8)
- Add dev command to build with hot reloading [`482af7fd`](https://github.com/area17/twill/commit/482af7fd1cc30d342ab4ddcb18d0ae98062000c8)
- Linter fixes [`6676c8e0`](https://github.com/area17/twill/commit/6676c8e0c0f480c131798e0030e9a6fc858a9601)
- Update vue-cli, sass-loader, sass and eslint [`3ca864bc`](https://github.com/area17/twill/commit/3ca864bca95f3809fdecfa4342699ec510cb39a0)
- Update dependencies and add dist assets [`ea3d7a99`](https://github.com/area17/twill/commit/ea3d7a99885ed1b1742ab8ca47bfa02e7558eb9b)
- Add dev mode to frontend build [`1cfd81e2`](https://github.com/area17/twill/commit/1cfd81e2a21be1045608f075440c99f3228cf7e9)
- Fix icons references outside of Vue apps [`c183b914`](https://github.com/area17/twill/commit/c183b9144fe4c69c7ffd30e05a6516e13159693e)
- Review updates [`20f2e022`](https://github.com/area17/twill/commit/20f2e02231208139b5a57534eafe4c46de24e250)
- Keep mix config for retro-compatibility [`0a0692bf`](https://github.com/area17/twill/commit/0a0692bfac99238e3a0bd2b72139f94637c4586c)
- Fix print twill version [`fb0236f2`](https://github.com/area17/twill/commit/fb0236f2543657640c7a7c3d59c87cc591769155)
- Fix print version. [`4cfd4f61`](https://github.com/area17/twill/commit/4cfd4f611ff992801d13ef5bd003bfeb700f95d8)
- Show twill version from value retrieve into twill object [`ed4de74f`](https://github.com/area17/twill/commit/ed4de74feb20fd60267b1b06f1ec58cbd2a74da8)
- Expose twill version into FE [`e37b4cd1`](https://github.com/area17/twill/commit/e37b4cd1c65ab778324fe932bb86dbecd096f049)
- Update php build task [`228105a3`](https://github.com/area17/twill/commit/228105a31a953ecf2f5ca56f60d82db3df675b2d)
- Build twill UI with vue-cli: - update blade template - fix vue.config.js configuration - put all twill informations inside window.TWILL object [`fbad6585`](https://github.com/area17/twill/commit/fbad6585edbcc3a9d73331d06b18123e53a7e253)
- WIP on cli implementation [`d4f04f6b`](https://github.com/area17/twill/commit/d4f04f6b50d12415ea7ea2ddf572e866ba17834f)
- Wip on vue-cli config [`2ac51b3c`](https://github.com/area17/twill/commit/2ac51b3c219680947561234801d59c9784f96a6f)
- Clean dist folder [`5f49f67c`](https://github.com/area17/twill/commit/5f49f67c061af397ea5224efa4c5907b696aae33)
- Clean frontend dependencies and define global vue variables for app name and app version [`471f654f`](https://github.com/area17/twill/commit/471f654faa95c27281a7a2df1fef0caa310d4308)
- WIP on vue-cli build integration: > Set default sass settings in each components (clean components) > Create alias to FE directory > Generate Sprite SVG within SVGSpritemapPlugin > Generate manifest file within WebpackAssetsManifest > Add entry points for each vue app (form / listing / dashboard / buckets ) [`160743b4`](https://github.com/area17/twill/commit/160743b4ab06cf46ce20c4c1992069ddd2082060)
- Update es-lint configuration and fix components [`b92c9d95`](https://github.com/area17/twill/commit/b92c9d95e007570e17f5ea6e136657e292c528f5)
- Begin vue-cli implementation [`0f326d59`](https://github.com/area17/twill/commit/0f326d594452cc22b8ef3bb21e2fa594449d2379)
- Refactor webpack SVG spritemap config [`82b35ac2`](https://github.com/area17/twill/commit/82b35ac2df0b2a9ae39f5fbf0187d9eea65226c4)
- Remove mix configuration [`cedbea45`](https://github.com/area17/twill/commit/cedbea45c06f8afd4da1989704802b5084e67258)
- Make custom blocks path configurable [`9a754806`](https://github.com/area17/twill/commit/9a75480625412c3b499a7e557bdfded742f6fe8a)
- Update vuedraggable dependency [`45ff20c1`](https://github.com/area17/twill/commit/45ff20c1223b3facb8916014ab1f732d9348a188)

#### Translation models
- *@antonio*
- [`#414`](https://github.com/area17/twill/pull/414) Define a default locale on table mediables [`c4e3c3fa`](https://github.com/area17/twill/commit/c4e3c3fa75daa0c37641f9f4bc1395870f9d7908)
- Rebase and review feature/disable translations [`957702ac`](https://github.com/area17/twill/commit/957702ac0ecd84e541293d7790e96d6200358412)
- Fix isTranslatable() for the user model [`7a783deb`](https://github.com/area17/twill/commit/7a783debf8e2e8af60ce2f3938673c66f8e8d33d)
- Use module model's translatedAttributes as fillable for the translation model [`cc958d4d`](https://github.com/area17/twill/commit/cc958d4d4282d76fa81f0d725bbc07c03c85724d)
- Allow to easily disable module translations [`c8151ede`](https://github.com/area17/twill/commit/c8151eded958c475d1a040bdbc1011fe10d05dc0)


#### Migration updates
- Use big integers in migrations helpers [`b3fd5819`](https://github.com/area17/twill/commit/b3fd5819b0cde430c7cda3543d4242927892de05)
> This is a breaking change with backwards compatibility provided through the `twill.migrations_use_big_integers` configuration key.
- Fix #41 – Use text columns for medias and files uuid, alt_text, caption and filename [`96cdebd8`](https://github.com/area17/twill/commit/96cdebd8abc88abaeeb3b866448f96c047b400be)
...
#### Smarter CLI
- *@yanholi and @ifox*
- Improve CLI module generator [`a9de8155`](https://github.com/area17/twill/commit/a9de8155d0319e47483bdaa36f9866aed029ddc4)
...
- Enhance the module maker to ask questions regards options [`c73154f2`](https://github.com/area17/twill/commit/c73154f2bd91d83d8fa735bb8467e3aea9004805)

### Automated testing
- *@antonio*
- Remove phpstan analysis from composer test command [`38e224ea`](https://github.com/area17/twill/commit/38e224ea9e6d8c93d5304e5162acec0f56772598)
- Some cleanup and best practices from phpstan feedback [`e1e67949`](https://github.com/area17/twill/commit/e1e67949ae576e229d1350df665fd1f9c549c932)
- Fix PHP 7.1 tests [`213b2c9b`](https://github.com/area17/twill/commit/213b2c9bcd2d3e96af794d8a8f2ad8c5a70bc804)
> Filesystem::missing didn't exist prior to Laravel 6.0, see https://github.com/illuminate/filesystem/commit/197bac14e3f49d2c39f37e4a8ae1422ac08d50cf
- [`#516`](https://github.com/area17/twill/pull/516) Add larastan rule to phpstan [`5af10938`](https://github.com/area17/twill/commit/5af109386e9ebad0341aead0d53ad39a34d96507)
- [`#517`](https://github.com/area17/twill/pull/517) Check for syntax errors using PHP-CS-Fixer [`3a3605b6`](https://github.com/area17/twill/commit/3a3605b6ad9358f3ec997739ea4d896e2ce5aea2)
...
#### OAuth login
- *@ferpetrelli*
- Fix oauth login when 2FA is disabled [`d07002e3`](https://github.com/area17/twill/commit/d07002e3432374ef20581891c1cd88f7e2a36fa3)
- Merge branch 'pr/439-oauth-login' [`afd14245`](https://github.com/area17/twill/commit/afd14245cb0499f367be2c40a0e9fa84e02dcc1e)
- Review updates [`06ec2d4e`](https://github.com/area17/twill/commit/06ec2d4e8986c9d58ce047082c3cd75e6dd4daf1)
...
- Implement Login with Oauth via Socialite [`be848d6e`](https://github.com/area17/twill/commit/be848d6e2a3081e9d8944ddec8ccfb16f7ad37ec)
> Implement a process to create/link oauth users with Twill users
> Ask for the current password if the user currently exists and it has a password.
> Ability to select a default Role for new Oauth Users

#### JSON fields groups
- *@yanhaoli*
- [`#410`](https://github.com/area17/twill/pull/410) Add a feature to group fields in a JSON column [`5564e488`](https://github.com/area17/twill/commit/5564e48801d97e28c350c2250b0b3f36efa54444)
- [`#452`](https://github.com/area17/twill/pull/452) Add a default value for `$fieldsGroups` to prevent error from repositories which extend ModuleRepository. [`657e83cf`](https://github.com/area17/twill/commit/657e83cf7191f44a81a6051c04ff9a9c62cac8e1)
- [`#501`](https://github.com/area17/twill/pull/501) When saving the fields groups to db, the value should not be encoded to json string [`b48793af`](https://github.com/area17/twill/commit/b48793af5ea9ef8e3e54761f58402786a54881ba)
- [`#541`](https://github.com/area17/twill/pull/541) Fix null decoded json field groups value [`74926425`](https://github.com/area17/twill/commit/7492642564e65e84646e3d9f930227bdc2400540)
- Fix fields groups hydration [`6437a073`](https://github.com/area17/twill/commit/6437a0732ff1983196ab716395d18677cab3bc45)
- Fix empty fields groups [`84176e44`](https://github.com/area17/twill/commit/84176e448e47d63339bf2ffa3ac9224f3ca5dc42)

#### Destroy item in the trash
- *@pablobarrios*
- Fix tests by adding new routes [`1b0f0070`](https://github.com/area17/twill/commit/1b0f0070ca670ae441a974150d31e82724e85e57)
- Add warning modal on destroy, bulk destroy and bulk delete [`578da43d`](https://github.com/area17/twill/commit/578da43df70a5f9ce3c0915f44ba25644adbf153)
...
- Fix media and file libraries upload endpoint logic [`4bf2e133`](https://github.com/area17/twill/commit/4bf2e133e9841b12f92f955ab0440fed0769f202)

#### Free layout
- *@pablobarrios*
- Update free layout docs [`f1f62e16`](https://github.com/area17/twill/commit/f1f62e1695b7f5ba5f6e6cce9b64d620148940a1)
- Fix opening media library in free layout [`b72b6d12`](https://github.com/area17/twill/commit/b72b6d125c419a5b5ac3fde890dc0db2ed05c341)
- Update free layout yield and class naming [`6040300e`](https://github.com/area17/twill/commit/6040300e3e376303bba1cd6d16f686013ce764e7)
- Add support for Twill form fields and buttons in free layout [`ef4e748d`](https://github.com/area17/twill/commit/ef4e748d35435abacd793b232b864179460a18c3)
- Added Documentation for the Free template with examples [`cc79fd83`](https://github.com/area17/twill/commit/cc79fd8388631d35520f9f3cec843ecd633b8871)
- Added HTML structure to align the Free content with the main viewport [`42869139`](https://github.com/area17/twill/commit/4286913956dca3d76656f8a0f57740755ac39031)
- Added new layout to enable insert custom pages in the Admin [`8b5271d5`](https://github.com/area17/twill/commit/8b5271d579ebc4193d15e3d13b9dd24480f1e950)
- Added proper JS and CSS changes
- Added new layout to enable insert custom pages in the Admin [`ca5f3ce0`](https://github.com/area17/twill/commit/ca5f3ce0196f6f9e45f4e5e8a4d80d76146345f9)
- Added proper JS and CSS changes

#### Automated browsers and repeaters
- *@yanhaoli*
- [`#400`](https://github.com/area17/twill/pull/400) Automated Browser and Repeater Fields [`968e7da2`](https://github.com/area17/twill/commit/968e7da28f81129e43369004690e75db4b341c99)
- [`#467`](https://github.com/area17/twill/pull/467) Fix HandleBrowsers arraykey handling [`f5cef179`](https://github.com/area17/twill/commit/f5cef1797570d1b8c54acf9d84998d9d1765c075)
- Fixed hydrate methods for automated repeaters and browsers [`89c2297c`](https://github.com/area17/twill/commit/89c2297c07ca69fa9462d1e6e5ed42024e179e42)
- Fix automated browsers and repeaters handling when using custom properties [`6fd64187`](https://github.com/area17/twill/commit/6fd641879e92cedcf96bed0d5969251abcff033a)

#### Duplicate
- *@ferpetrelli*
- Fix routes test for duplicate feature [`bb706c26`](https://github.com/area17/twill/commit/bb706c26eb666779bef5748827d6e258a626dc04)
- Update api error management after rebasing master [`a4e2d870`](https://github.com/area17/twill/commit/a4e2d8708da6fe804874f92ac1a5e6ec795b7341)
- Cleanup duplicate repository action [`068b6f2c`](https://github.com/area17/twill/commit/068b6f2c98f626e0be56a3b17aa1d0098e10170b)
- Respond with a notification and a redirection when duplicating an item. [`8e39f165`](https://github.com/area17/twill/commit/8e39f16564e998591ba5e417130326c5f2dafe83)
- First working approach to duplication. [`a32100e9`](https://github.com/area17/twill/commit/a32100e9b9fac1225e701a880e329bcafd87c4ac)
- Implement interaction path for entities duplication. [`bcce64fd`](https://github.com/area17/twill/commit/bcce64fd4d12fb6a4827926c36cfb05728996d85)

#### i18n
- *@yanhaoli*
- [`#563`](https://github.com/area17/twill/pull/563) Create lang.php for French 
- [`#565`](https://github.com/area17/twill/pull/565) Updated user form to include French language 
- [`#566`](https://github.com/area17/twill/pull/566) Add portuguese (brazil and portugal) translations 
...
#### Subdomain routing
- *@ifox*
- Persist the active_subdomain in config [`a4bdf225`](https://github.com/area17/twill/commit/a4bdf225259fa3b3f25d9d6127acc1dcb8d52693)
- Fix login redirect when using subdomain routing [`5f2d642b`](https://github.com/area17/twill/commit/5f2d642b8966251a9ecc3829aae0b2007d17ffbb)
- Add support for subdomain admin routing [`ffdbe75a`](https://github.com/area17/twill/commit/ffdbe75ae2f347e35f0302448c3c254a8e45ac03)
...
- Update anchor behavior [`cf25ee82`](https://github.com/area17/twill/commit/cf25ee8242754f1e1536da9b691ab60aa83126ef)
- Add anchor quill module [`e8b450db`](https://github.com/area17/twill/commit/e8b450db4153d9d1436f32db68daf36a85311bf9)
- Define min width of cell at 80px [`6d396a16`](https://github.com/area17/twill/commit/6d396a16cacf36d7cc6840577b67aea5b02c49f1)
- Move wysiwyg svg sprite declaration at main layout level [`6bb6e25b`](https://github.com/area17/twill/commit/6bb6e25b060e68ff1e529c58cba4ef0ec38f1be0)
- Select wich wysiwyg based on param (default is Quill) [`5f798ef6`](https://github.com/area17/twill/commit/5f798ef6c6d2fc85b7ac173916b03fd8de21c1a3)
- Implement basic tiptap wysiyg functionalities [`bc58e7e3`](https://github.com/area17/twill/commit/bc58e7e3f9db918d58f32034f223897d9fa2f63e)
- Set up tiptap wywsiwyg [`6323071b`](https://github.com/area17/twill/commit/6323071b269011079429e8355674156d0215db3d)
- WIP - implementing tiptap [`584a622e`](https://github.com/area17/twill/commit/584a622e3c2686aaab3e57f6be192eb100ba22ab)
...
> The note option is already supported but displays inside of the field, not to the right to its label like on regular fields. This adds a new fieldNote option to be able to use both locations.
...
> Extract creation of filter options array
> Mark current filter in listings as selected
> Allow application of default filters in listing view
...
- Form - Add disabled property in the submitOptions (so the submit options is appearing but cant be clicked) [`9129e642`](https://github.com/area17/twill/commit/9129e6423ba684e6c953eaabf91274ba6715f582)
...
> Available to form Blade as a publisherRows section
...
- Merge pull request #489 from mrdoinel/feature/additionnal-links-buckets-listing [`c4c22bee`](https://github.com/area17/twill/commit/c4c22beeef2e2a0811319a674c93b4d31398ed3e)
- Add Links into the buckets options [`24873d24`](https://github.com/area17/twill/commit/24873d2415313a3b542f4afc8d9ea7ba39d665e6)
- Add FilterLinks on Listings [`3a83a069`](https://github.com/area17/twill/commit/3a83a06942129d2c32baec121203ac7ab14b09d3)
...
- [`#431`](https://github.com/area17/twill/pull/431) fixed the http & https issue from APP URL [`abb1509f`](https://github.com/area17/twill/commit/abb1509f3306046c58b88dab5325a7ad9b8f1692)
- [`#446`](https://github.com/area17/twill/pull/446) Fixed the issue that 'delete' => true not working in indexOptions, refs #289 [`81a32414`](https://github.com/area17/twill/commit/81a3241464b3dc92dcad2b7d1e7172e471f306a5)
...
- [`#503`](https://github.com/area17/twill/pull/503) Change app()->get to ->make in GlideController [`27b012d2`](https://github.com/area17/twill/commit/27b012d27dd44a58ef989f9ca05d2000f7634c49)
...
- [`#539`](https://github.com/area17/twill/pull/539) Fix getSlug() function when locale fallback is activated that’s create an infinite requests [`c48ca396`](https://github.com/area17/twill/commit/c48ca39632b95c5584df438111f94459ab2c373a)
...
- typo fix for issue #362 [`ac76481c`](https://github.com/area17/twill/commit/ac76481cb4c1fcba0baacce9983c6eb60ca3a951)
...
> when uploading multiple files at once, the endpoint root was appended once for each file
> when not providing the environment variable, null was appended
- Fix missing AWS_ROOT variable [`2a467f22`](https://github.com/area17/twill/commit/2a467f22688495a2190ab10f1de3008daedee363)
- Change app()->get to ->make [`4ddce127`](https://github.com/area17/twill/commit/4ddce1272ebffd8658f2c5bf5bab34531f61cb1d)
...
> Removed the VERSION file, use the constant VERSION in TwillServiceProvider to store it instead
...
- Merge pull request #487 from mrdoinel/feature/refactor-button [`8431a14c`](https://github.com/area17/twill/commit/8431a14c7b2fb57e95cd2fa8b327dd4f2569962f)
...
> Translated attributes after sorted remove used keys.
> This works well to avoid collision with ambiguous names in Sqlsrv.
> So we first sort by traits, and then by defaults.
