...
return [
    ...
    'listing' => [
        ...
        'reorder' => [
            'success' => 'Ordine di :modelTitle cambiato!',
            'error' => 'Ordine di :modelTitle non cambiato. Qualcosa è andato storto!',
        ],
        'restore' => [
            'success' => ':modelTitle ripristinato!',
            'error' => ':modelTitle non è stato ripristinato. Qualcosa è andato storto!',
        ],
        'bulk-restore' => [
            'success' => 'Elementi :modelTitle ripristinati!',
            'error' => 'Elementi :modelTitle non sono stati ripristinati. Qualcosa è andato storto!',
        ],
        'force-delete' => [
            'success' => ':modelTitle distrutto!',
            'error' => ':modelTitle non è stato distrutto. Qualcosa è andato storto!',
        ],
        'bulk-force-delete' => [
            'success' => 'Elementi :modelTitle distrutti!',
            'error' => 'Elementi :modelTitle non sono stati distrutti. Qualcosa è andato storto!',
        ],
        'delete' => [
            'success' => ':modelTitle spostato nel cestino!',
            'error' => ':modelTitle non è stato spostato nel cestino. Qualcosa è andato storto!',
        ],
        'bulk-delete' => [
            'success' => 'Elementi :modelTitle spostati nel cestino!',
            'error' => 'Elementi :modelTitle non sono stati spostati nel cestino. Qualcosa è andato storto!',
        ],
        'duplicate' => [
            'success' => ':modelTitle duplicato!',
            'error' => ':modelTitle non è stato duplicato. Qualcosa è andato storto!',
        ],
        'publish' => [
            'unpublished' => ':modelTitle rimosso dalla pubblicazione!',
            'published' => ':modelTitle pubblicato!',
            'error' => ':modelTitle non è stato pubblicato. Qualcosa è andato storto!',
        ],
        'featured' => [
            'unfeatured' => ':modelTitle rimosso dai promsossi!',
            'featured' => ':modelTitle promosso!',
            'error' => ':modelTitle non è stato promosso. Qualcosa è andato storto!',
        ],
        'bulk-featured' => [
            'unfeatured' => 'Elementi :modelTitle rimossi dai promossi!',
            'featured' => 'Elementi :modelTitle promossi!',
            'error' => 'Elementi :modelTitle non sono stati promossi. Qualcosa è andato storto!',
        ],
        'bulk-publish' => [
            'unpublished' => 'Elementi :modelTitle rimossi dalla pubblicazione!',
            'published' => 'Elementi :modelTitle pubblicati!',
            'error' => ':modelTitle items were not published. Qualcosa è andato storto!',
        ],
    ],
    'main' => [
        'create' => 'Crea',
    ...
    'notifications' => [
        'reset' => [
            ...
            'subject' => ':appName | Reimposta password',
        ],
        'welcome' => [
    ...
    'publisher' => [
        ...
        'editing-draft-revision' => 'Stai modificando una revisione bozza di questo contenuto. Fare le modifiche necessarie e fare clic su "Salva come revisione" o "Pubblica".',
        'revisions' => 'Revisioni',
    ...
    'user-management' => [
        ...
        'enable-user-and-close' => 'Abilita utente e chiudi',
        'enable-user-and-create-new' => 'Abilita utente e crea nuovo',
        'enabled' => 'Abilitati',
        'language' => 'Lingua',
        ...
        'update-disabled-and-close' => 'Aggiorna disabilitato e chiudi',
        'update-disabled-user' => 'Aggiorna utente disabilitato',
        'update-disabled-user-and-create-new' => 'Aggiorna utente disabilitato e crea nuovo',
        'user-image' => 'Immagine',
        'users' => 'Utenti',
    ],
    'settings' => [
